...
import io.github.mvillafuertem.scalcite.example.domain.repository.{QueriesRepository, ScalciteRepository}
...
/**
  ...
  */
final class ScalciteApplicationImpl(sqlRepository: QueriesRepository[TypeZStream],
...
object ScalciteApplicationImpl {
  def apply(sqlRepository: QueriesRepository[TypeZStream],
